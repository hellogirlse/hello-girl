...
function Navigation(props) {
    ...
    return (
        <header ref={headerRef} className={`bg-white ${style.header} ${sticky ? style.sticky : ''}`}>
                ...
                <nav className={style.header__nav}>
                    <ul className={style.header__nav__menu}>
                        ...
                        <li className={style.header__nav__menu__item}>
                            ...
                            onClick={(e) => {
                                e.preventDefault();
                                document.getElementById('event-och-kurser').scrollIntoView({ behavior: 'smooth', block: 'start' });
                        ...
                        <li className={style.header__nav__menu__item}>
                            ...
                            onClick={(e) => {
                                e.preventDefault();
                                document.getElementById('vanner').scrollIntoView({ behavior: 'smooth', block: 'start' });
