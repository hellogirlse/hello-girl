        ...
        <section id="om-oss" className={`bg-primary ${style.primary}`}>
            <div className={`container ${style.primary__container}`}>
                ...
                <div className={style.primary__container__wrapper}>
                    ...
                    <p>
                        Idag är det endast 28% som arbetar inom IT-sektorn i Sverige som är kvinnor. 
                    ...
                    <p>
                        ...
                        Vissa med funderingar om att söka en IT-utbildning, några med viljan om att göra ett karriärbyte och andra som vill få mer förståelse av tech för att öka sina chanser till jobb.
                    </p>
                </div>
